...
BOLT_CLIENT_ID=; BOLT_CLIENT_SECRET=; BOLT_BASE_URL=https://node.bolt.eu/fleet-integration-gateway; BOLT_AUTH_URL=https://oidc.bolt.eu/token; BOLT_DEFAULT_FLEET_ID=
```
