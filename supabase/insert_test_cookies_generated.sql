...
-- Alternative si la contrainte unique n'existe pas : DELETE puis INSERT
-- Décommenter les lignes ci-dessous et commenter la requête ci-dessus si nécessaire :
/*
DELETE FROM heetch_session_cookies 
WHERE org_id = 'default_org' AND phone_number = '+33743617110';
